...
public class MainActivity extends AppCompatActivity implements AutoPermissionsListener{
    ...
    Button btnCall, btnWhat, btnIns;
    EditText editCall, txtName, txtEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWhat.setOnClickListener(v -> {editCall.setText(getContacts());});
    ...
    public void addContact(){
        ...
        intent.putExtra(ContactsContract.Intents.Insert.EMAIL, txtEmail.getText())
                ...
                .putExtra(ContactsContract.Intents.Insert.PHONE, txtName.getText())
